  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50" onClick={onClose}>
      <div className="bg-green-400 rounded-xl p-6 w-full max-w-lg relative" onClick={(e) => e.stopPropagation()}>
        <h2 className="text-2xl font-bold text-blue-700 mb-4">Website / Web Application</h2>
        <p className="text-gray-800">
          We design and develop responsive, SEO-ready websites and powerful web applications — tailored for businesses, portfolios, and systems.
        </p>
